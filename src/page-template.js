...
// Generate main HTML to be returned
const generatePage = (data) => {
  // destructure projects and about data from templateData based on their property key names
  const { name, username, about, projects } = data;
  ...
  <body>
    <header>
      <div class="container flex-row justify-space-between align-center py-3">
        ...
        <nav class="flex-row">
          <a class="ml-2 my-1 px-2 py-1 bg-secondary text-dark" href="https://github.com/${username}">
          GitHub</a>
        </nav>
      </div>
    </header>
